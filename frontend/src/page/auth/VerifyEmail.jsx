...
function VerifyEmail({ onGoToLogin }) {
  ...
  const hasVerified = useRef(false); // ← guard agar tidak dipanggil 2x
          ...
          <div className="p-10 text-center">
            ...
            {status === "loading" && (
              <>
                ...
                <p className="text-xs font-semibold uppercase tracking-widest text-gray-400 mb-2">Memproses</p>
            ...
            {status === "success" && (
              <>
                ...
                <p className="text-xs font-semibold uppercase tracking-widest text-gray-400 mb-2">Selesai</p>
            ...
            {status === "error" && (
              <>
                ...
                <p className="text-xs font-semibold uppercase tracking-widest text-gray-400 mb-2">Gagal</p>
