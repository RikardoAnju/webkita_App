...
const PricingPage = () => (
  <div style={{
    ...
    <p style={{
      ...
      Halaman paket layanan belum dibuat.
    </p>
  </div>
);
...
const AdminDashboard = () => {
  ...
  const fetchAll = useCallback(async () => {
    ...
    try {
      ...
      setOrders(Array.isArray(ordersData) ? ordersData.map(transformProject) : []);
      setUsers(Array.isArray(usersData) ? usersData.map(transformUser) : []);
  ...
  const PAGE_META = {
    dashboard: {
      title: "Dashboard",
      subtitle: "Ringkasan aktivitas platform Webkita",
    },
    orders: {
      title: "Manajemen Orderan",
      subtitle: `${orders.length} orderan terdaftar`,
    },
    users: {
    ...
    pricing: {
      title: "Paket Layanan",
      subtitle: "Kelola paket layanan Webkita",
    },
  };
    ...
    <div style={{
      ...
      <main style={{
        ...
        <div style={{
          ...
          {page === "pricing" && (
            <PricingTable onRefresh={fetchAll} />
          )}
        </div>
      </main>
